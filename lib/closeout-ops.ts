...
function readContractFormData(formData: FormData) {
  ...
  return {
    data: {
      ...
      buyer_readiness_status: "not_started",
      seller_readiness_status: "not_started",
      readiness_reviewed_at: null,
      readiness_reviewed_by: null,
      buyer_packet_status: "not_started",
      seller_packet_status: "not_started",
      execution_status: "not_started",
      buyer_execution_status: "not_started",
      seller_execution_status: "not_started",
      execution_ready_at: null,
      execution_completed_at: null,
      execution_reviewed_by: null,
