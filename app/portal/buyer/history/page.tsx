...
import { summarizeHistory, getBuyerHistoryFeed } from "@/lib/history";
...
export default async function BuyerHistoryPage() {
  ...
  const events = await getBuyerHistoryFeed(record.id);
  ...
  return (
    <PortalShell
      ...
      title="Buyer history"
      description="Safe history feed for your own buyer-linked chain."
      role="buyer"
      ...
      <div className="grid gap-6">
        ...
        <PageCard title="History feed" description="Only safe labels and timestamps are shown here.">
          <HistoryFeed
            ...
            emptyDescription="Activity appears once your buyer chain records meaningful events."
          />
          <div className="mt-4">
            <Link
              href="/portal/buyer"
